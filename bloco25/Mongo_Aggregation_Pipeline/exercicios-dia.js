...
//retornar somente os clientes do sexo "FEMININO" e com data de nascimento entre os anos de 1995 e 2005 .
db.clientes.aggregate([
  {
    $project: {
      _id: 0,
...
db.clientes.aggregate([
  ...
  },
  {
    $project: {
      _id: 0,
      estado: '$_id.uf', // pegando o agrupado
      sexo: '$_id.sexo',
      total: 1,
    },
  },
