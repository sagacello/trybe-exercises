//Suponha que você esteja lidando com carros e, da forma como o problema lhe foi entregue, cada carro é modelado como um array. Porém, essa modelagem está baixo nível. 
...
const toObject = (lista) => {
    return {name: lista[0] , brand: lista[1] , year:lista[2]}
}
