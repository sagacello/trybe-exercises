...
function fantasyOrScienceFictionAuthors() {
    let selecionarGeneros =  books.filter((busca) => ( busca['genre'] == 'Ficção Científica' ||  busca['genre'] == 'Fantasia'))
    let ordem = selecionarGeneros.map((busca) => busca['author']['name']).sort()
    return ordem
